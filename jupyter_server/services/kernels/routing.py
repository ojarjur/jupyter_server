...
class RoutingKernelManagerWebsocketConnection(BaseKernelWebsocketConnection):
    ...
    async def close_all(cls):
        await ZMQChannelsWebsocketConnection.close_all()
    ...
    async def connect(self):
        ...
        return await ensure_async(self.wrapped.connect())
    ...
    def nudge(self):
        if hasattr(self.wrapped, "nudge"):
            return self.wrapped.nudge()

    def write_stderr(self, *args):
        if hasattr(self.wrapped, "write_stderr"):
            return self.wrapped.write_stderr(*args)

    def on_kernel_restarted(self):
        if hasattr(self.wrapped, "on_kernel_restarted"):
            return self.wrapped.on_kernel_restarted()

    def on_restart_failed(self):
        if hasattr(self.wrapped, "on_restart_failed"):
            return self.wrapped.on_restart_failed()

    def _on_error(self, *args):
        if hasattr(self.wrapped, "_on_error"):
            return self.wrapped._on_error(*args)
